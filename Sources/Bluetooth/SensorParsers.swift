...
enum SensorParsers {
    static func decode(characteristicUUID: CBUUID, data: Data) -> [SensorReading] {
    ...
    static func heartRate(from data: Data) -> SensorReading? {
    ...
    static func batteryLevel(from data: Data) -> SensorReading? {
    ...
    static func pulseOximeter(from data: Data) -> SensorReading? {
    ...
    static func rscCadenceAndDistance(from data: Data) -> [SensorReading] {
